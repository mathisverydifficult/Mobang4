...
<script type = "text/javascript">
	function pay(index) {
		var form = document.payOne;
		var form2 = document.payTwo;
		var form3 = document.payThree;
		var form4 = document.payFour;
		if(index ==1) {
			form.action = "agent_pay.agent"
		}
		else if(index ==2) {
			form2.action = "agent_pay.agent"
		}
		else if(index ==3) {
			form3.action = "agent_pay.agent"
		}
		else if(index ==4) {
			form4.action = "agent_pay.agent"
		}
		form.submit();
		form2.submit();
		form3.submit();
...
<%@ include file="form/agent_header.jsp" %>
    			...
    			<li class = "sales_item">
    				<form name = "payOne" method="post">
	    				<div class="summary">
	    					...
	    					<h2>원/투/쓰리룸 일반 상품</h2>
	    					<input type = "hidden" name = "name_it" value = "'원/투/쓰리룸 상품'"/>
	    					<p>단독, 다가구, 다세대 등 <br/>매물 10개를 등록할 수 있습니다.</p>
	    				</div>
	    				<div>
	    					<h1>88,000원</h1>
	    					<input type = "hidden" name="price_it" value="88000"/>
	    					<input type = "submit" class="item_buy" value = "구매하기" onclick="pay(1)"/>
	    				</div>
    				</form>
    			</li>
    			<li class = "sales_item">
    				<form name = "payTwo" method="post">
	    				<div class="summary">
	    					...
	    					<h2>오피스텔 일반 상품</h2>
	    					<input type = "hidden" name = "name_it" value = "'오피스텔 상품'"/>
	    					<p>오피스텔 매물 5개를<br/> 등록할 수 있습니다.</p>
	    				</div>
	    				<div>
	    					<h1>44,000원</h1>
	    					<input type = "hidden" name = "price_it" value = "44000"/>
	    					<input type = "submit" class = "item_buy" value = "구매하기" onclick="pay(2)"/>
	    				</div>
    				</form>
    			</li>
    		</ul>
    ...
    <section id = "plus_p" class = "sales_view">
        ...
        <div class = "container _img">
            <ul>
                <li class = "sales_item">
                	<form name = "payThree" method="post">
	                    <div class="summary">
	                        ...
	                        <h2>플러스 정기권</h2>
	              			<input type = "hidden" name = "name_it" value = "'플러스 정기권'"/>
	                        <p>누구나 구매 가능합니다.</p>
	                    </div>
	                    <div>
	                        <h1>18,000원</h1>
	                        <input type = "hidden" name="price_it" value="18000"/>
	                        <input type = "submit" class="item_buy" value = "구매하기" onclick="pay(3)"/>
	                    </div>
                    </form>
                </li>
                <li class = "sales_item">
                	<form name = "payFour" method="post">
	                    <div class="summary">
	                        ...
	                        <h2>플러스 1일권</h2>
	                        <input type = "hidden" name = "name_it" value = "'플러스 1일권'"/>
	                        <p>누구나 구매 가능합니다.</p>
	                    </div>
	                    <div>
	                        <h1>1,000원</h1>
	                        <input type = "hidden" name="price_it" value="1000"/>
	                        <input type = "submit" class="item_buy" value = "구매하기" onclick="pay(4)"/>
	                    </div>
                    </form>
                </li>
           </ul>
