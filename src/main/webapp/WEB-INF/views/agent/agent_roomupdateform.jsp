...
<%@ include file="form/agent_header.jsp" %>
	<section class = "top_container">
        <div class = "container">
			...
			<form action="agent_roomupdateres.agent" method="post" enctype="multipart/form-data">
    ...
    <section class = "photo_container">
    	<div class = "container _01">
    		...
    		<!--	<c:forEach items="${imagelist }" var="image" varStatus="status">
      				<a onclick="deleteImageAction(${status.index})"><img id="img_id_${status.index}" src="${image }" class='selProductFile'></a>
      			</c:forEach> 
      			<input id="listsize" type="hidden" value="${fn:length(imagelist)} ">
      		 -->
